...
// src/Select/SelectNew.tsx
var React3 = __toESM(require_react());

// src/Select/Select.tsx
var React2 = __toESM(require_react());
var _Select = class extends React2.Component {
  constructor(props) {
    super(props);
  ...
  getItem(id) {
    let item;
    this.component.objectData.items.forEach((objData) => {
  ...
  onSelect({ target }) {
    let selections = [];
    Array.prototype.slice.call(target.selectedOptions).forEach((selectedItem) => {
      selections.push(selectedItem.value);
    });
    let selectedObjData = new FlowObjectDataArray();
    selections.forEach((externalID) => {
    ...
    this.component.objectData?.items.forEach((item) => {
      options.push(
        /* @__PURE__ */ React2.createElement(
          ...
          item.properties[this.component.columns[0]?.developerName]?.value
        )
      );
    });
    const selectProps = {
...
// src/Select/SelectNew.tsx
var ExtendedSelect = class extends FCMNew {
